...
<?php 
	...
	//ENVIO DE PETICIONES AL CONTROLADOR
	if (!empty($_POST)) {
...
<body>
		<!-- Modal -->
			<div class="modal fade" id="mensajeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index: 99999">
		...
		<div class="fondo">
					...
					<div class="form-group row">
		 	 		...
		 	 		<div class="form-group row">
			 	 		...
			 	 		<div class="col-4">
			 	 			...
			 	 			<div class="alert" style="align-content: center "><?php echo isset($alert) ? $alert : '';  ?></div>
			...
			<nav class="navbar navbar-light bg-light">
				  <a class="navbar-brand" ><img src="img\icons\vuelo2.svg" width="30" height="30" class="d-inline-block align-top" alt=""> VUELOS</a>
			</nav>
	...
	$(document).ready(function(){
		...
		$("#selector_hora").change(function(){
			...
			$("#selector_hora").each(function(){
				...
				$.post("../controlador/controller.php",{fecha:$('#selector_fecha').val(),ciudadE:$('#selector_ciudades').val(), horaP:$('#selector_hora').val()},function($data){
					/*$("#cod_vuelo").html($data);*/
					$("#puesto").val($data);
				});
...
<script type="text/javascript">
	$(document).ready(function()
      {
	function view_mensaje(mensaje){
		
		$('.modal-body').load('mensaje',function(){
